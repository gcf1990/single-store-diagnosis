...
- QA 必须证明 403 行 / 30001 目标守恒、8 家异常状态映射可追溯、`MQ257T -> MQ256T` 唯一名称映射、角色权限不扩张、4 个日期边界、1280/1366/1440 浅深主题、非目标主链路不回归。
- 锁定非目标：不改销售总览、过程分析、打铁指标、负向问题率、门店详情跳转、销售导出、截图协议、移动端、父应用筛选器、转大定展示、依赖或发布配置。本次仅更新 `Product-Spec.md`、`Product-Spec-CHANGELOG.md`、`DEV-PLAN.md`，未改源码、未发布、未 commit/push。
